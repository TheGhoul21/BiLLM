...
def tokenize_and_align_labels(examples):
    tokenized_inputs = tokenizer(examples["prompt"], is_split_into_words=False, padding='longest', max_length=args.max_length, truncation=True)
    labels = tokenizer(examples["output"], is_split_into_words=False, padding='longest', max_length=args.max_length, truncation=True)
    tokenized_inputs["labels"] = labels['input_ids'].copy()
